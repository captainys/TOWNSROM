...
int RandomWrite(const char fName[],size_t position,size_t length,size_t stepWrite,int closeEveryPiece)
{
	int err=0;
	size_t i,nSeg;
	FILE *fp=fopen(fName,"wb");
...
int TestRandom(const char fName[],size_t position,size_t length,size_t stepWrite,int closeEveryPiece)
{
	if(0!=RandomWrite(fName,position,length,stepWrite,closeEveryPiece) ||
	   0!=Verify(fName,position,length))
	{
		return 1;
	}
...
int main(int ac,char *av[])
{
	...
	printf("All Write then All Read\n");
	if(0!=Test("TEST01.BIN",0,DATA_BUF_LEN,0x7fffffff,0))
	{
		printf("Error!\n");
		return 1;
	}

	printf("Little by Little (without Close)\n");
	if(0!=Test("TEST02.BIN",0x1000,640,17,0))
	{
		printf("Error!\n");
		return 1;
	}

	printf("Little by Little (Close Every Step)\n");
	if(0!=Test("TEST03.BIN",0x1000,640,17,1))
	{
		printf("Error!\n");
		return 1;
	}

	printf("Longer than Cluster (without Close)\n");
	if(0!=Test("TEST04.BIN",0x4000,68000,2345,0))
	{
		printf("Error!\n");
		return 1;
	}

	printf("Longer than Cluster (Close Every Step)\n");
	if(0!=Test("TEST05.BIN",0x4000,68000,2345,1))
	{
		printf("Error!\n");
		return 1;
	}

	printf("Random Write Little by Little\n");
	if(0!=TestRandom("TEST.BIN",1487,4098,17,0))
	{
		printf("Error!\n");
		return 1;
	}
	printf("Random Write Little by Little (Close Every Step)\n");
	if(0!=TestRandom("TEST04.BIN",1487,4098,17,1))
	{
		printf("Error!\n");
		return 1;
	}
	...
	if(0!=TestRandom("TEST05.BIN",1487,71234,4321,0))
	{
		printf("Error!\n");
		return 1;
	}
	printf("Random Write Longer than Cluster (Close Every Step)\n");
	if(0!=TestRandom("TEST06.BIN",1487,71234,4321,1))
	{
		printf("Error!\n");
		return 1;
	}
